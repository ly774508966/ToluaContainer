...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		L.EndModule();
		L.EndModule();
		L.BeginModule("ToluaContainer");
		ToluaContainer_CommandWrap.Register(L);
		ToluaContainer_CommandDispatcherWrap.Register(L);
		ToluaContainer_CommanderContainerAOTWrap.Register(L);
		ToluaContainer_CommanderContainerExtensionWrap.Register(L);
		ToluaContainer_CommandReferenceWrap.Register(L);
		ToluaContainer_EventBehaviourWrap.Register(L);
		ToluaContainer_EventContainerAOTWrap.Register(L);
		L.BeginModule("Container");
		ToluaContainer_Container_BinderWrap.Register(L);
		ToluaContainer_Container_BindingWrap.Register(L);
		ToluaContainer_Container_BindingFactoryWrap.Register(L);
		ToluaContainer_Container_InjectionContainerWrap.Register(L);
		ToluaContainer_Container_CommandDispatchWrap.Register(L);
		ToluaContainer_Container_CommanderUtilsWrap.Register(L);
		ToluaContainer_Container_CommandExceptionWrap.Register(L);
		ToluaContainer_Container_NamespaceCommandBehaviourWrap.Register(L);
		ToluaContainer_Container_TimedCommandDispatchWrap.Register(L);
		ToluaContainer_Container_ContextRootWrap.Register(L);
		ToluaContainer_Container_AssetBundleInfoWrap.Register(L);
		ToluaContainer_Container_PrefabInfoWrap.Register(L);
		ToluaContainer_Container_UnityBindingExtensionWrap.Register(L);
		ToluaContainer_Container_UnityContainerAOTWrap.Register(L);
		ToluaContainer_Container_InjectorWrap.Register(L);
		L.RegFunction("BindingAddedHandler", ToluaContainer_Container_BindingAddedHandler);
		L.RegFunction("BindingRemovedHandler", ToluaContainer_Container_BindingRemovedHandler);
		L.RegFunction("Condition", ToluaContainer_Container_Condition);
		L.RegFunction("TypeResolutionHandler", ToluaContainer_Container_TypeResolutionHandler);
		L.RegFunction("BindingEvaluationHandler", ToluaContainer_Container_BindingEvaluationHandler);
		L.RegFunction("BindingResolutionHandler", ToluaContainer_Container_BindingResolutionHandler);
		L.RegFunction("InstanceInjectionHandler", ToluaContainer_Container_InstanceInjectionHandler);
		L.EndModule();
		L.EndModule();
		L.BeginModule("Utils");
		Utils_CompareUtilsWrap.Register(L);
		Utils_MethodUtilsWrap.Register(L);
		Utils_ExceptionsWrap.Register(L);
		Utils_TypeUtilsWrap.Register(L);
		L.EndModule();
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int ToluaContainer_Container_BindingAddedHandler(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateFactory.CreateDelegate(typeof(ToluaContainer.Container.BindingAddedHandler), func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateFactory.CreateDelegate(typeof(ToluaContainer.Container.BindingAddedHandler), func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int ToluaContainer_Container_BindingRemovedHandler(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateFactory.CreateDelegate(typeof(ToluaContainer.Container.BindingRemovedHandler), func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateFactory.CreateDelegate(typeof(ToluaContainer.Container.BindingRemovedHandler), func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int ToluaContainer_Container_Condition(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateFactory.CreateDelegate(typeof(ToluaContainer.Container.Condition), func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateFactory.CreateDelegate(typeof(ToluaContainer.Container.Condition), func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int ToluaContainer_Container_TypeResolutionHandler(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateFactory.CreateDelegate(typeof(ToluaContainer.Container.TypeResolutionHandler), func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateFactory.CreateDelegate(typeof(ToluaContainer.Container.TypeResolutionHandler), func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int ToluaContainer_Container_BindingEvaluationHandler(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateFactory.CreateDelegate(typeof(ToluaContainer.Container.BindingEvaluationHandler), func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateFactory.CreateDelegate(typeof(ToluaContainer.Container.BindingEvaluationHandler), func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int ToluaContainer_Container_BindingResolutionHandler(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateFactory.CreateDelegate(typeof(ToluaContainer.Container.BindingResolutionHandler), func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateFactory.CreateDelegate(typeof(ToluaContainer.Container.BindingResolutionHandler), func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int ToluaContainer_Container_InstanceInjectionHandler(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateFactory.CreateDelegate(typeof(ToluaContainer.Container.InstanceInjectionHandler), func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateFactory.CreateDelegate(typeof(ToluaContainer.Container.InstanceInjectionHandler), func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
